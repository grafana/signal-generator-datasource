...
import (
	...
	"github.com/grafana/waveform-datasource/pkg/common"
...
func (p *Parser) Parse(buf []byte) ([]*models.InfluxLine, error) {
	...
	metrics := make([]*models.InfluxLine, 0)
...
func (p *Parser) ParseLine(line string) (*models.InfluxLine, error) {
...
func (p *Parser) parseRecord(record []string) (*models.InfluxLine, error) {
...
func parseTimestamp(timeFunc func() time.Time, recordFields map[string]interface{},
	...
	if timestampColumn != "" {
		...
		default:
			metricTime, err := common.ParseTimestamp(timestampFormat, recordFields[timestampColumn], "UTC")
			if err != nil {
