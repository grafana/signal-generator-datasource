...
func (s *serializer) Serialize(metric *models.InfluxLine) ([]byte, error) {
...
func (s *serializer) SerializeBatch(metrics []*models.InfluxLine) ([]byte, error) {
...
func (s *serializer) createObject(metric *models.InfluxLine) map[string]interface{} {
