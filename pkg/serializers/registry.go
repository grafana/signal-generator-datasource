...
import (
	...
	"github.com/grafana/waveform-datasource/pkg/serializers/json"
)
...
type Serializer interface {
	...
	// delimited metrics.
	Serialize(metric *models.InfluxLine) ([]byte, error)
	...
	SerializeBatch(metrics []*models.InfluxLine) ([]byte, error)
}
